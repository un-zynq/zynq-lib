...
// ==================== MAIN ZYNQ OBJECT (FIXED) ====================
const ZYNQ = {
  games: new ZYNQ_Core(),
  deviceType: null,
  Peer: ZYNQPeer,        // capital P (kept for backward compatibility)
  peer: ZYNQPeer,        // ←←← THIS WAS MISSING → now ZYNQ.peer is the constructor
...
export const peer = ZYNQ.Peer;   // lowercase export still works

export { ZYNQPeer as defaultPeer }; // optional extra
